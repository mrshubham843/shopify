...
{
    /** API URL */
    public $api_url = 'https://cheapestsmmpanels.com/api/v2';

    /** Your API key */
    public $api_key = 'a8aaa7f90ae18e832feaf137c5a3c4b3';
...
$services = $api->services(array('id' => '2970')); # Return all services
echo "<pre>";print_r($services);die("ss");
